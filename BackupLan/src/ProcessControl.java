	...
	public void run() {
		...
		while (true) {
			...
			for (int i = 0; i < sendQueue.size(); i++) {
				...
				if (sendQueue.get(i).type.equals("STORED")) {
				...
				} else if (sendQueue.get(i).type.equals("GETCHUNK")) {

					message = "GETCHUNK" + " " + sendQueue.get(i).version + " " + sendQueue.get(i).senderId + " "
							+ sendQueue.get(i).fileId + " " + sendQueue.get(i).chunkNr + " " + "\r\n" + "\r\n";
					...
					try {
						...
						System.out.println("Sent getchunk message");
